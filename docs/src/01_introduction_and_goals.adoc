...
| _Estudiantes_ | _Richard Robin Roque del Rio, Luis Jose Remuñan Ovies, Enol Ruiz Barcala, Ikram El Mabrouk Morhnane, Omayma El Imami Gaada_ | _Equipo responsable del análisis, diseño, implementación y documentación del sistema._
| _Usuarios_ | _Personas que usen la aplicación_ | _Experiencia de juego sencilla, rápida y acceso a estadísticas._
| _Profesores_ | _José Emilio Labra, Pablo González, Celia Melendi Lavandera, Diego Martín Fernández_ | _Supervisión del proyecto y evaluación de la calidad técnica y documental._
|===
